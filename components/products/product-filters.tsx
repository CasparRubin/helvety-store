...
export function ProductFilters({ value, onChange, className, counts }: ProductFiltersProps) {
  return (
...
export function ProductFiltersCompact({ value, onChange, className }: ProductFiltersCompactProps) {
  return (
